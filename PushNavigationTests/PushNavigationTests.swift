...
class PushNavigationUnitTests: XCTestCase {
    ...
    func testJustGoDownTwo() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1_1_1", from: S1_1.self, rootNode: S1.self)
    ...
    func testJustGoDownTwoButLevelLower() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1_1_1", from: S1_1_1.self, rootNode: S1.self)
        XCTAssertEqual(result.count, 1)
        assertActionItem(0, action: .Down, node: S1_1_1_1.self)
    }
    
    func testGoToRoot() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1", from: S1_1_1_1.self, rootNode: S1.self)
        XCTAssertEqual(result.count, 1)
        assertActionItem(0, action: .Up, node: S1_1.self)
    }
    
    func testGoOneUp() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1_1", from: S1_1_1_1.self, rootNode: S1.self)
        XCTAssertEqual(result.count, 1)
        assertActionItem(0, action: .Up, node: S1_1_1.self)
    }
    
    func testCommonNearest() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1_1_3", from: S1_1_1_1.self, rootNode: S1.self)
        assertActionItem(0, action: .Up, node: S1_1_1.self)
        assertActionItem(1, action: .Down, node: S1_1_1_3.self)
    }
    
    func testCommonMiddleWay() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_1_2_2", from: S1_1_1_1.self, rootNode: S1.self)
        assertActionItem(0, action: .Up, node: S1_1.self)
    ...
    func testCommonOnlyRoot() {
        result = NodePathFinder.pathBetweenNodes(destination: "1_3_3_3", from: S1_1_1_1.self, rootNode: S1.self)
